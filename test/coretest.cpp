...
* @Last Modified time: 2015-11-30 21:34:46
*/
...
TEST(coretest_slipL_create_IntNode, slipL_create_IntNode)
{
	slip_IntNode* int_node = slipL_create_IntNode(15);
	EXPECT_EQ(int_node->value, 15);
}

TEST(coretest_slipL_create_IntNodeFromStr, slipL_create_IntNodeFromStr)
{
...
TEST(coretest_slipL_create_FloatNode, slipL_create_FloatNode) 
{
	slip_FloatNode* f_node = slipL_create_FloatNode(19.6);
	EXPECT_EQ(f_node->value, 19.6);
}

TEST(coretest_slipL_create_FloatNodeFromStr, slipL_create_FloatNodeFromStr) 
{
...
TEST(coretest_slipL_parseString, slipL_parseString) 
{
